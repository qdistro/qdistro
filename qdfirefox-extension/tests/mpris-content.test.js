...
function load(env) {
  ...
  // URL-less script) so V8 coverage attributes lines to src/content/mpris-content.js.
  // No parsingContext => current (jsdom) context, so document/navigator stay available.
