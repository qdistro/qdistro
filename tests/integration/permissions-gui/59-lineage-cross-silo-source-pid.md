...
# Echo the matched startup line itself, so the assertion has visible evidence
# rather than resting on the waiter having printed anything.
...
this step by looking for text the waiter itself printed.
