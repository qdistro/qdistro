...
Singleton {
  ...
  function getBasename(path) {
    ...
    if (schemeName === "Qdshell-default") {
      return "Qdshell (default)";
    } else if (schemeName === "Qdshell-legacy") {
      return "Qdshell (legacy)";
  ...
  function resolveSchemePath(nameOrPath) {
    ...
    // Handle special cases for Qdshell schemes
    var schemeName = nameOrPath.replace(".json", "");
    if (schemeName === "Qdshell (default)") {
      schemeName = "Qdshell-default";
    } else if (schemeName === "Qdshell (legacy)") {
      schemeName = "Qdshell-legacy";
    } else if (schemeName === "Tokyo Night") {
