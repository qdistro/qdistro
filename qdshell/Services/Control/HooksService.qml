...
Singleton {
  ...
  Connections {
    ...
    function onQdshellPerformanceModeChanged() {
      const isEnabled = PowerProfileService.qdshellPerformanceMode;
  ...
  function init() {
    ...
    Qt.callLater(() => {
                   ...
                   wasPerformanceModeEnabled = PowerProfileService.qdshellPerformanceMode;
                   // Execute startup hook
                   executeStartupHook();
                 });
  }
