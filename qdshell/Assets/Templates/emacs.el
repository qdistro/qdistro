;;; qdshell-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme qdshell "Theme using Template variables with quality of life improvements.")
...
(provide-theme 'qdshell)
;;; qdshell-theme.el ends here
